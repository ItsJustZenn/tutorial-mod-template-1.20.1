package name.zenn.tutorial.entity.custom;
...
public class ManedWolfEntity extends AnimalEntity implements GeoEntity {
    ...
    public @Nullable PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.MANEDWOLF.create(world);
    }
    ...
    private PlayState predicate(AnimationState<ManedWolfEntity> manedWolfEntityAnimationState) {
